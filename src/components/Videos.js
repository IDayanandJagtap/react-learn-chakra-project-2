...
const Videos = () => {
    // This could have been an array of objects containing title, description and other info about the video ! 
    const videosArr = [
    ...
    return(
        <Stack direction={['column', 'row']} mb={'8'}>
            ...
            <VStack w={['full', 'xl']} alignItems={'stretch'} py={'4'} px={'2'}>
                <Heading pb={'1'}>Playlist</Heading>
                <VStack alignItems={'stretch'} overflow={'auto'} rowGap={'2'}>
